...
def loadCenTrainCIFAR10(device):
    ...
    return torch.utils.data.DataLoader(ImageDatasetFromImagePathsAndLabel(imagePaths, labels, device, __CIFAR10_TRANSFORMS__), batch_size=__CIFAR10_BATCH_SIZE__, shuffle=False, num_workers=8)
...
def loadMIADataCIFAR10(device):
    ...
    return torch.utils.data.DataLoader(ImageDatasetFromImagePathsAndLabel(imagePaths, labels, device, __CIFAR10_TRANSFORMS__), batch_size=__CIFAR10_BATCH_SIZE__, shuffle=False, num_workers=8), memberLabels, inOutLabels